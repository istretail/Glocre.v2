...
export interface TrackingEndpoint {
     ...
     */
    createTracking(tracking_post_params: TrackingCreateParams): Promise<Tracking>;
    /**
     * Delete a tracking.
     ...
     */
    updateTracking(single_tracking_param: SingleTrackingParam, tracking_update_params?: TrackingUpdateParams): Promise<Tracking>;
    /**
